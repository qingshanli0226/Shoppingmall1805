package com.bawei.shopmall.user.fragment;
 ...
 */
public class UserFragment extends BaseFragment<HomeImpl, HomeContract.IHomeView> implements HomeContract.IHomeView,View.OnClickListener {
