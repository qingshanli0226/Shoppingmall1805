...
public class Recyadapter extends BaseRVAdapter<Object> {
    ...
    private void displayseckill(Object o, BaseViewHoder holder) {
        Log.i("---","664");
        List<Recommonde.SeckillInfoBean.ListBean> seckillInfoBeans= (List<Recommonde.SeckillInfoBean.ListBean>) o;
    ...
    private void displayrecommonde(Object o, BaseViewHoder holder) {
        List<Recommonde.RecommendInfoBean> recommendInfoBeans= (List<Recommonde.RecommendInfoBean>) o;
    ...
    private void displayhot(Object o, BaseViewHoder holder) {
        List<Recommonde.HotInfoBean> hotInfoBeans= (List<Recommonde.HotInfoBean>) o;
    ...
    private void displayact(Object o, BaseViewHoder holder) {
            List<Recommonde.ActInfoBean> actInfoBeans= (List<Recommonde.ActInfoBean>) o;
    ...
    private void displaychannel(Object o,final BaseViewHoder holder) {
        List<Recommonde.ChannelInfoBean> channelInfoBeans = (List<Recommonde.ChannelInfoBean>)o;
    ...
    private void displaybanner(Object o, BaseViewHoder holder) {
        List<Recommonde.BannerInfoBean> bannerInfoBeans = (List<Recommonde.BannerInfoBean>) o;
       final Banner banner = holder.getView(R.id.banner);
        ...
        for (int i = 0; i < bannerInfoBeans.size(); i++) {
            banimgs.add(Contants.Gui_Url+bannerInfoBeans.get(i).getImage());
        }
