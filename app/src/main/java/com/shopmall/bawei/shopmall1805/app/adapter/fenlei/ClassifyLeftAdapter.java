...
public class ClassifyLeftAdapter extends RecyclerView.Adapter<ClassifyLeftAdapter.MyHolder> {

    private List<String> list;
    private Context context;

    public ClassifyLeftAdapter(List<String> list, Context context) {
        this.list = list;
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.classify_small_left_item, null);
