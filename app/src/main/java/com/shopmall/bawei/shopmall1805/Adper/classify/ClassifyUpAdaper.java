...
public
class ClassifyUpAdaper extends BaseQuickAdapter<ClothesBean.ResultBean.ChildBean, BaseViewHolder> {
    public ClassifyUpAdaper(int layoutResId, @Nullable List<ClothesBean.ResultBean.ChildBean> data) {
