...
import com.shopmall.bawei.shopmall1805.adapter.HomeNewAdapter;
import com.shopmall.bawei.shopmall1805.adapter.HomeShoppingAdapter;
import com.shopmall.bawei.shopmall1805.adapter.HomeXinAdapter;
import com.shopmall.bawei.shopmall1805.adapter.HometitleAdapter;
import com.shopmall.bawei.shopmall1805.banner.Bannerl;
...
public class HomeFragment extends BaseMVPFragment<HomePresenter> implements Constart.HomeConstartView {
    ...
    protected void createViewid(View inflate) {
        bannerF1 = (Banner) inflate.findViewById(R.id.banner_f1);
        titleF1 = (RecyclerView) inflate.findViewById(R.id.title_f1);
        banner2F1 = (Banner) inflate.findViewById(R.id.banner2_f1);
        homeRecycleGou = (RecyclerView) inflate.findViewById(R.id.home_recycle_gou);
        homeRecycleNew = (RecyclerView) inflate.findViewById(R.id.home_recycle_new);
        homeRecycleShopping = (RecyclerView) inflate.findViewById(R.id.home_recycle_shopping);
    }
    ...
    public void Success(Object... objects) {
        ...
        Bannerl.getBannerl().bann(bannerF1,image2);
        Bannerl.getBannerl().bann(banner2F1,image);
