...
public class FenleiDwonAdapter extends BaseQuickAdapter<ClothesBean.ResultBean.ChildBean, BaseViewHolder> {

    public FenleiDwonAdapter(int layoutResId, @Nullable List<ClothesBean.ResultBean.ChildBean> data) {
