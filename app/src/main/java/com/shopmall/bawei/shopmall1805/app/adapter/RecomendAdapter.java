...
public class RecomendAdapter extends BaseQuickAdapter<HomeBean.ResultBean.RecommendInfoBean, BaseViewHolder> {

    public RecomendAdapter(int layoutResId, @Nullable List<HomeBean.ResultBean.RecommendInfoBean> data) {
