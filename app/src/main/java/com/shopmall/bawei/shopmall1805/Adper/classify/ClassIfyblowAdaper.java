...
public
class ClassIfyblowAdaper extends BaseQuickAdapter<ClothesBean.ResultBean.HotProductListBean, BaseViewHolder> {

    public ClassIfyblowAdaper(int layoutResId, @Nullable List<ClothesBean.ResultBean.HotProductListBean> data) {
