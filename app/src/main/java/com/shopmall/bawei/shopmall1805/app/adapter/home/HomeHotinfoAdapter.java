...
public class HomeHotinfoAdapter extends BaseQuickAdapter<HomeBean.ResultBean.HotInfoBean, BaseViewHolder> {

    public HomeHotinfoAdapter(int layoutResId, @Nullable List<HomeBean.ResultBean.HotInfoBean> data) {
