...
public class HomeHotAdapter extends BaseQuickAdapter<HomeBean.ResultBean.HotInfoBean, BaseViewHolder> {
    public HomeHotAdapter(int layoutResId, @Nullable List<HomeBean.ResultBean.HotInfoBean> data) {
