...
public class FenLeiTwoAdapter extends BaseQuickAdapter<FenLeiVpTwoEntity.ResultBean, BaseViewHolder> {

    public FenLeiTwoAdapter(int layoutResId, @Nullable List<FenLeiVpTwoEntity.ResultBean> data) {
