...
public class ClassificationSmallHotAdapter extends BaseQuickAdapter<SkirstBean.ResultBean.HotProductListBean, BaseViewHolder> {
    public ClassificationSmallHotAdapter(int layoutResId, @Nullable List<SkirstBean.ResultBean.HotProductListBean> data) {
