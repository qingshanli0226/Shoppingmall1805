...
public class ToorBar extends RelativeLayout {
    ...
    public ToorBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context,attrs,0);
    }

    public ToorBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initToolBarAttrs(Context context, AttributeSet attrs) {
        //获取Toolbar在布局中定义的属性值
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.shopmall.bawei.common.R.styleable.ToolBar);
        isShowLeft = typedArray.getBoolean(com.shopmall.bawei.common.R.styleable.ToolBar_left_show, true);
        isShowTitle = typedArray.getBoolean(com.shopmall.bawei.common.R.styleable.ToolBar_title_show,true);
        rightText = typedArray.getString(com.shopmall.bawei.common.R.styleable.ToolBar_right_text);
        rightImgId = typedArray.getResourceId(com.shopmall.bawei.common.R.styleable.ToolBar_right_src,0);
        leftImgId = typedArray.getResourceId(com.shopmall.bawei.common.R.styleable.ToolBar_left_src,0);
        rightTextColor = typedArray.getColor(com.shopmall.bawei.common.R.styleable.ToolBar_right_text_color, Color.BLACK);
        rightTextSize = typedArray.getInt(com.shopmall.bawei.common.R.styleable.ToolBar_right_text_size, 0);
        titleText = typedArray.getString(com.shopmall.bawei.common.R.styleable.ToolBar_title_text);
        isShowRight = typedArray.getBoolean(com.shopmall.bawei.common.R.styleable.ToolBar_right_show, true);
        isRightOnlyText = typedArray.getBoolean(com.shopmall.bawei.common.R.styleable.ToolBar_right_show_only_text, false);
        isRightOnlyImg = typedArray.getBoolean(com.shopmall.bawei.common.R.styleable.ToolBar_right_show_only_img, false);
    }
