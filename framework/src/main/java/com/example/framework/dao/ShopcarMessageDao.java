...
public class ShopcarMessageDao extends AbstractDao<ShopcarMessage, Long> {
    ...
    public static class Properties {
        ...
        public final static Property RequesltOne = new Property(6, String.class, "requesltOne", false, "REQUESLT_ONE");
        public final static Property RequesltTwo = new Property(7, String.class, "requesltTwo", false, "REQUESLT_TWO");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SHOPCAR_MESSAGE\" (" + //
                ...
                "\"REQUESLT_ONE\" TEXT," + // 6: requesltOne
                "\"REQUESLT_TWO\" TEXT);"); // 7: requesltTwo
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, ShopcarMessage entity) {
        ...
        String requesltOne = entity.getRequesltOne();
        if (requesltOne != null) {
            stmt.bindString(7, requesltOne);
        }
 
        String requesltTwo = entity.getRequesltTwo();
        if (requesltTwo != null) {
            stmt.bindString(8, requesltTwo);
        }
    }
    ...
    public ShopcarMessage readEntity(Cursor cursor, int offset) {
        ShopcarMessage entity = new ShopcarMessage( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // requesltOne
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7) // requesltTwo
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, ShopcarMessage entity, int offset) {
        ...
        entity.setRequesltOne(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setRequesltTwo(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
     }
