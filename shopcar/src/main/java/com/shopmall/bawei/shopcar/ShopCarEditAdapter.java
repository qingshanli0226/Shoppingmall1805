...
public class ShopCarEditAdapter extends BaseRvAdapter<ShopCarBean.ResultBean> {
    private Context context;
    private IOnShopCarItemChildClickListener listener;
    private List<Boolean> isChecks=new ArrayList<>();
    public ShopCarEditAdapter(Context context, IOnShopCarItemChildClickListener listener) {
