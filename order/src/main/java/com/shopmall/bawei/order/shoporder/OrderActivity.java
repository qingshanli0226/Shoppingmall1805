            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        resultBean.setTotalPrice(moneyValue);
                        resultBean.setTime(System.currentTimeMillis()+"");
                        List<FindForSendBean.ResultBean> list = CacheManager.getInstance().getFindForSendList();
                        list.add(resultBean);
                        ...
                        resultBean.setTotalPrice(moneyValue);
                        resultBean.setTime(System.currentTimeMillis()+"");
                        List<FindForPayBean.ResultBean> list = CacheManager.getInstance().getFindForPayList();
                        list.add(resultBean);
                    }
